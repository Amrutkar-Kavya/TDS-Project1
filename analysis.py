...
print("ANS 1: Top 5 users in Paris by followers:", ', '.join(top_5_paris_users['login']))
...
print("ANS 6: Second most popular language for users after 2020:", second_popular_language)
...
print("ANS 7: Language with highest average stars per repo:", avg_stars_per_language)

# Question 8: Top 5 users by leader_strength
users_df['leader_strength'] = users_df['followers'] / (1 + users_df['following'])
top_5_leader_strength = users_df.nlargest(5, 'leader_strength')['login']
print("ANS 8: Top 5 users by leader_strength:", ', '.join(top_5_leader_strength))

# Question 9: Correlation between followers and public repositories
correlation = users_df['followers'].corr(users_df['public_repos'])
print("ANS 9: Correlation between followers and public repos:", correlation)
...
print("ANS 10: Regression estimate", slope)
...
print("ANS 11: Correlation between projects and wiki enabled:", correlation_projects_wiki)
...
print("ANS 12: Difference in avg following:", hireable_following_avg - non_hireable_following_avg)
...
slope= bio_model.params['bio_word_count']
print("ANS 13: Regression slope for bio length on followers:", slope)
...
print("ANS 14: Top 5 users creating most repos on weekends:", ', '.join(top_weekend_creators.index))
...
print("ANS 15: ", email_hireable-email_non_hireable)
...
print("ANS 16: Most common surname(s):", ', '.join(most_common_surnames))
